          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    { resource: 'CPU Usage', current: 45, limit: 80, status: 'normal', icon: '🖥️' },
                    { resource: 'Memory Usage', current: 68, limit: 85, status: 'normal', icon: '💾' },
                    { resource: 'Disk Storage', current: 82, limit: 90, status: 'warning', icon: '💿' },
                    { resource: 'Network I/O', current: 34, limit: 70, status: 'normal', icon: '🌐' },
                    { resource: 'Database Load', current: 56, limit: 75, status: 'normal', icon: '🗄️' },
                    { resource: 'API Requests', current: 89, limit: 95, status: 'warning', icon: '🔗' }
                  ].map((resource, index) => (
