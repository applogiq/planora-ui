...
export function SimpleDragDropKanban({ project, user, masterData: propMasterData, masterLoading: propMasterLoading }: SimpleDragDropKanbanProps) {
  ...
  // Use master data from props or fallback to hook (for backwards compatibility)
